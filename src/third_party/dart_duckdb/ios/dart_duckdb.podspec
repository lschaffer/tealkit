...
A new flutter plugin project.
  ...
  s.prepare_command = <<-CMD
    ...
    if [ ! -f "Libraries/release/duckdb.framework/duckdb" ]; then
      echo "Downloading DuckDB library..."
       # v1.4.1 asset is no longer available; v1.4.2 is the current hosted iOS framework archive.
      ...
      echo "DuckDB library already exists and includes the binary."
    fi
  CMD
end
