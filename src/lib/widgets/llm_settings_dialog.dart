    ...
    setState(() {
      if (fromServer) {
        ...
        _enable2ndStageToolFiltering =
            ...
            : s.enable2ndStageToolFiltering;
        _toolFilteringLlmSource =
            (remote['tool_filtering_llm_source'] as String?) ?? s.toolFilteringLlmSource;
      } else {
                    ...
                    ListView(
                      ...
                      children: [
                        ...
                        LlmSettingsFormWidget(
                          ...
                          maxToolOutputSizeController: _maxToolOutputSizeCtrl,
                          tokenWarningThresholdController:
    ...
    return ListView(
      ...
      children: [
        ...
        LlmSettingsFormWidget(
          ...
          topKController: _topKCtrl2,
          topPController: _topPCtrl2,
          repeatPenaltyController: _repeatPenaltyCtrl2,
          seedController: _seedCtrl2,
          maxToolOutputSizeController: _maxToolOutputSizeCtrl2,
          tokenWarningThresholdController: _tokenWarningThresholdCtrl2,
          isSlm: _isSlm2,
