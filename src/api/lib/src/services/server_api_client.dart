...
class ServerApiClient {
  ...
  static const _timeout = Duration(
    seconds: 30,
  ); // Reduced from 60s to fail faster
  ...
  Map<String, dynamic> _normalizeTaskTransportJson(
  ...
  Future<bool> ping() async {
    try {
      final r = await http
          .get(Uri.parse(_url('/health')), headers: _headers)
          .timeout(_healthTimeout);
      return r.statusCode == 200;
    } catch (e) {
      _logWarning(
        '[ServerApiClient] ping timeout after ${_healthTimeout.inSeconds}s: $e',
      );
      return false;
    }
  }
  ...
  Future<bool> validateAuthorization({Duration? timeout}) async {
    final requestTimeout =
        timeout ??
        _sslTimeout; // Use SSL timeout by default (faster than _timeout)
    try {
      ...
      if (e.statusCode == 401 || e.statusCode == 403) {
        _logWarning(
          '[ServerApiClient] authorization denied: ${e.statusCode} ${e.message}',
        );
        return false;
      }
      _logWarning(
        '[ServerApiClient] authorization check API error: ${e.statusCode} ${e.message}',
      );
      return false;
    } catch (e) {
      _logWarning(
        '[ServerApiClient] authorization check timeout/network error after ${requestTimeout.inSeconds}s: $e',
      );
      return false;
    }
  }
  ...
  Future<List<WorkflowTask>> getAllTasks() async {
    final r = await http
        .get(Uri.parse(_url('/api/v1/tasks')), headers: _headers)
        .timeout(_timeout);
    _checkStatus(r);
  ...
  Future<WorkflowTask?> getTask(String id, {Duration? timeout}) async {
    final r = await http
        .get(Uri.parse(_url('/api/v1/tasks/$id')), headers: _headers)
        .timeout(timeout ?? _timeout);
    if (r.statusCode == 404) return null;
    _checkStatus(r);
    return WorkflowTask.fromJson(
      _normalizeTaskTransportJson(jsonDecode(r.body) as Map<String, dynamic>),
    );
  }
  ...
  Future<void> saveTask(WorkflowTask task) async {
    ...
    final r = await http
        .put(
          Uri.parse(_url('/api/v1/tasks/${task.id}')),
          headers: _headers,
  ...
  Future<void> deleteTask(String id) async {
    final r = await http
        .delete(Uri.parse(_url('/api/v1/tasks/$id')), headers: _headers)
        .timeout(_timeout);
    _checkStatus(r);
  }
  ...
  Future<void> toggleTask(String taskId, bool enabled) async {
    final r = await http
        .put(
          Uri.parse(_url('/api/v1/tasks/$taskId')),
          headers: _headers,
  ...
  Future<String> runTask(String taskId) async {
    final r = await http
        .post(Uri.parse(_url('/api/v1/tasks/$taskId/run')), headers: _headers)
        .timeout(_timeout);
    _checkStatus(r);
    final body = jsonDecode(r.body) as Map<String, dynamic>;
  ...
  Future<void> cancelTask(String taskId) async {
    final r = await http
        .post(
          Uri.parse(_url('/api/v1/tasks/$taskId/cancel')),
          headers: _headers,
        )
        .timeout(_timeout);
    _checkStatus(r);
  ...
  Future<bool> getTaskRunStatus(String taskId, {Duration? timeout}) async {
    final r = await http
        .get(
          Uri.parse(_url('/api/v1/tasks/$taskId/run-status')),
          headers: _headers,
        )
        .timeout(timeout ?? _timeout);
  ...
  Future<Map<String, dynamic>?> getTaskOutput(
    String taskId, {
    Duration? timeout,
  }) async {
    final r = await http
        .get(Uri.parse(_url('/api/v1/tasks/$taskId/output')), headers: _headers)
        .timeout(timeout ?? _timeout);
    if (r.statusCode == 404) return null;
    _checkStatus(r);
    return jsonDecode(r.body) as Map<String, dynamic>;
  ...
  Future<Map<String, dynamic>?> getTaskExecutionLogs(
    String taskId, {
    Duration? timeout,
  }) async {
    final r = await http
        .get(
          Uri.parse(_url('/api/v1/tasks/$taskId/execution-logs')),
          headers: _headers,
        )
        .timeout(timeout ?? _timeout);
    if (r.statusCode == 404) return null;
  ...
  Future<Map<String, dynamic>?> getTaskOutputFiles(
    String taskId, {
    Duration? timeout,
  }) async {
    final r = await http
        .get(
          Uri.parse(_url('/api/v1/tasks/$taskId/output-files')),
          headers: _headers,
        )
        .timeout(timeout ?? _timeout);
    if (r.statusCode == 404) return null;
  ...
  Future<Uint8List> downloadTaskOutputFile(
    String taskId,
    String runId,
    String fileName, {
    Duration? timeout,
  ...
  Future<String> downloadTaskOutputFileAsText(
    String taskId,
    String runId,
    String fileName, {
    Duration? timeout,
  }) async {
    final bytes = await downloadTaskOutputFile(
      taskId,
      runId,
      fileName,
      timeout: timeout,
  ...
  Future<Map<String, dynamic>> getSchedulerLog({
    int limit = 50,
    int offset = 0,
    Duration? timeout,
  }) async {
    final r = await http
        .get(
          Uri.parse(_url('/api/v1/scheduler/log?limit=$limit&offset=$offset')),
          headers: _headers,
        )
        .timeout(timeout ?? _timeout);
    _checkStatus(r);
  ...
  Future<Map<String, dynamic>> syncTasks(
    ...
    final r = await http
        .post(
          Uri.parse(_url('/api/v1/sync/tasks')),
          headers: _headers,
          body: jsonEncode({'tasks': normalizedTasks}),
        )
  ...
  Future<void> syncSettings(Map<String, dynamic> payload) async {
    final r = await http
        .post(
          Uri.parse(_url('/api/v1/sync/settings')),
          headers: _headers,
          body: jsonEncode(payload),
        )
        .timeout(_timeout);
  ...
  Future<Map<String, dynamic>> syncPyTools(
    List<Map<String, dynamic>> tools,
  ) async {
    final r = await http
        .post(
          Uri.parse(_url('/api/v1/sync/py_tools')),
          headers: _headers,
  ...
  Future<Map<String, dynamic>> initPyTool(String toolId) async {
    final r = await http
        .post(
          Uri.parse(
            _url('/api/v1/py_tools/${Uri.encodeComponent(toolId)}/init'),
          ),
          headers: _headers,
        )
  ...
  Future<Map<String, dynamic>> runPyTool(
    String toolId,
    ...
    final r = await http
        .post(
          Uri.parse(
            _url('/api/v1/py_tools/${Uri.encodeComponent(toolId)}/run'),
          ),
          headers: _headers,
  ...
  Future<Map<String, dynamic>> syncJsTools(
    List<Map<String, dynamic>> tools,
  ) async {
    final r = await http
        .post(
          Uri.parse(_url('/api/v1/sync/js_tools')),
          headers: _headers,
          body: jsonEncode({'tools': tools}),
        )
        .timeout(const Duration(seconds: 60));
  ...
  Future<Map<String, dynamic>> syncShellScripts(
    List<Map<String, dynamic>> scripts,
  ) async {
    final r = await http
        .post(
          Uri.parse(_url('/api/v1/sync/ssh_scripts')),
          headers: _headers,
  ...
  Future<Map<String, dynamic>> getLlmSettings({Duration? timeout}) async {
    final r = await http
        .get(Uri.parse(_url('/api/v1/settings/llm')), headers: _headers)
        .timeout(timeout ?? _timeout);
    _checkStatus(r);
    return jsonDecode(r.body) as Map<String, dynamic>;
  }
  ...
  Future<void> putLlmSettings(Map<String, dynamic> body) async {
    final r = await http
        .put(
          Uri.parse(_url('/api/v1/settings/llm')),
          headers: _headers,
          body: jsonEncode(body),
        )
        .timeout(_timeout);
  ...
  Future<Map<String, dynamic>> startServerModelDownload({
    ...
    final r = await http
        .post(
          Uri.parse(_url('/api/v1/models/downloads')),
          headers: _headers,
          body: jsonEncode(payload),
        )
        .timeout(_timeout);
  ...
  Future<Map<String, dynamic>> getServerModelDownloadJob(String jobId) async {
    final r = await http
        .get(
          Uri.parse(_url('/api/v1/models/downloads/$jobId')),
          headers: _headers,
        )
        .timeout(_timeout);
    _checkStatus(r);
  ...
  Future<Map<String, dynamic>> cancelServerModelDownload(String jobId) async {
    final r = await http
        .post(
          Uri.parse(_url('/api/v1/models/downloads/$jobId/cancel')),
          headers: _headers,
        )
        .timeout(_timeout);
    _checkStatus(r);
  ...
  Future<List<Map<String, dynamic>>> listServerModelFiles() async {
    final r = await http
        .get(Uri.parse(_url('/api/v1/models/files')), headers: _headers)
        .timeout(_timeout);
    _checkStatus(r);
    final body = jsonDecode(r.body) as Map<String, dynamic>;
  ...
  Future<void> deleteServerModelFile(String filename) async {
    ...
    final r = await http
        .delete(
          Uri.parse(_url('/api/v1/models/files/$encoded')),
          headers: _headers,
        )
        .timeout(_timeout);
    _checkStatus(r);
  ...
  Future<Map<String, dynamic>> getServerLoadedModel() async {
    final r = await http
        .get(Uri.parse(_url('/api/v1/models/loaded')), headers: _headers)
        .timeout(_timeout);
    _checkStatus(r);
    return jsonDecode(r.body) as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> loadServerModel(
    String filename, {
    int? gpuLayers,
  }) async {
    final r = await http
        .post(
          ...
          headers: _headers,
          body: jsonEncode({'filename': filename, 'gpuLayers': ?gpuLayers}),
        )
        .timeout(_timeout);
    _checkStatus(r);
    return jsonDecode(r.body) as Map<String, dynamic>;
  ...
  Future<Map<String, dynamic>> unloadServerModel() async {
    final r = await http
        .post(Uri.parse(_url('/api/v1/models/unload')), headers: _headers)
        .timeout(_timeout);
    _checkStatus(r);
    return jsonDecode(r.body) as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> getServerGpuCapabilities() async {
    final r = await http
        .get(Uri.parse(_url('/api/v1/models/gpu')), headers: _headers)
        .timeout(_timeout);
    _checkStatus(r);
    return jsonDecode(r.body) as Map<String, dynamic>;
  }
  ...
  Future<List<Map<String, dynamic>>> getServerCustomModels() async {
    final r = await http
        .get(Uri.parse(_url('/api/v1/models/custom')), headers: _headers)
        .timeout(_timeout);
    _checkStatus(r);
    final data = jsonDecode(r.body) as Map<String, dynamic>;
  ...
  Future<Map<String, dynamic>> getDataSourcesSettings({
    Duration? timeout,
  }) async {
    final r = await http
        .get(
          Uri.parse(_url('/api/v1/settings/data-sources')),
          headers: _headers,
        )
        .timeout(timeout ?? _timeout);
    _checkStatus(r);
  ...
  Future<Map<String, dynamic>> getExternalToolsSettings({
    Duration? timeout,
  }) async {
    final r = await http
        .get(
          Uri.parse(_url('/api/v1/settings/external-tools')),
          headers: _headers,
        )
        .timeout(timeout ?? _timeout);
    _checkStatus(r);
  ...
  Future<Map<String, dynamic>> startWebsiteIndex({
    required String urls,
    required int maxPages,
  }) async {
    final r = await http
        .post(
          Uri.parse(_url('/api/v1/index/website/start')),
          headers: _headers,
          body: jsonEncode({'urls': urls, 'max_pages': maxPages}),
        )
        .timeout(_timeout);
    _checkStatus(r);
    return jsonDecode(r.body) as Map<String, dynamic>;
  ...
  Future<void> stopWebsiteIndex() async {
    final r = await http
        .post(Uri.parse(_url('/api/v1/index/website/stop')), headers: _headers)
        .timeout(_timeout);
    _checkStatus(r);
  }

  /// Poll website indexing progress.
  Future<Map<String, dynamic>> getWebsiteIndexStatus({
    Duration? timeout,
  }) async {
    final r = await http
        .get(Uri.parse(_url('/api/v1/index/website/status')), headers: _headers)
        .timeout(timeout ?? _timeout);
    _checkStatus(r);
    return jsonDecode(r.body) as Map<String, dynamic>;
  }
  ...
  Future<Map<String, dynamic>> startDocumentIndex({
  ...
  Future<void> stopDocumentIndex() async {
    final r = await http
        .post(Uri.parse(_url('/api/v1/index/document/stop')), headers: _headers)
        .timeout(_timeout);
    _checkStatus(r);
  }
  ...
  Future<Map<String, dynamic>> getDocumentIndexStatus() async {
    final r = await http
        .get(
          Uri.parse(_url('/api/v1/index/document/status')),
          headers: _headers,
        )
        .timeout(_timeout);
    _checkStatus(r);
  ...
  Future<Map<String, dynamic>> listWebsiteIndexPages({
    String? domain,
    int limit = 50,
  }) async {
    ...
    final uri = Uri.parse(
      _url('/api/v1/index/website/pages'),
  ...
  Future<Map<String, dynamic>> getWebsiteIndexPage(String url) async {
    final uri = Uri.parse(
      _url('/api/v1/index/website/page'),
  ...
  Future<Map<String, dynamic>> purgeStaleWebsiteIndex() async {
    final r = await http
        .post(
          Uri.parse(_url('/api/v1/index/website/purge-stale')),
          headers: _headers,
        )
        .timeout(_timeout);
    _checkStatus(r);
  ...
  Future<Map<String, dynamic>> listDocumentIndexEntries({
    String? fileType,
    int limit = 100,
  }) async {
    final params = <String, String>{'limit': '$limit'};
    ...
    final uri = Uri.parse(
      _url('/api/v1/index/document/list'),
    ).replace(queryParameters: params);
    final r = await http.get(uri, headers: _headers).timeout(_timeout);
    _checkStatus(r);
    return jsonDecode(r.body) as Map<String, dynamic>;
  ...
  Future<Map<String, dynamic>> getDocumentIndexEntry(String filePath) async {
    final uri = Uri.parse(
      _url('/api/v1/index/document/entry'),
  ...
  Future<Map<String, dynamic>> purgeStaleDocumentIndex() async {
    final r = await http
        .post(
          Uri.parse(_url('/api/v1/index/document/purge-stale')),
          headers: _headers,
        )
        .timeout(_timeout);
    _checkStatus(r);
  ...
  Future<List<Map<String, dynamic>>> listRegistryServers() async {
    final r = await http
        .get(Uri.parse(_url('/api/v1/mcp/registry')), headers: _headers)
        .timeout(_timeout);
    _checkStatus(r);
    final body = jsonDecode(r.body) as Map<String, dynamic>;
  ...
  Future<Map<String, dynamic>> installRegistryServer(
    Map<String, dynamic> serverJson,
  ) async {
    final r = await http
        .post(
          Uri.parse(_url('/api/v1/mcp/registry')),
          headers: _headers,
          body: jsonEncode(serverJson),
        )
  ...
  Future<Map<String, dynamic>> updateRegistryServer(
    String id, {
    ...
    final r = await http
        .put(
          Uri.parse(_url('/api/v1/mcp/registry/$id')),
          headers: _headers,
          body: jsonEncode(payload),
        )
        .timeout(_timeout);
  ...
  Future<void> removeRegistryServer(String id) async {
    final r = await http
        .delete(Uri.parse(_url('/api/v1/mcp/registry/$id')), headers: _headers)
        .timeout(_timeout);
    _checkStatus(r);
  }
  ...
  Future<Map<String, dynamic>> testRegistryServer(String id) async {
    final r = await http
        .post(
          Uri.parse(_url('/api/v1/mcp/registry/$id/test')),
          headers: _headers,
        )
        .timeout(const Duration(seconds: 60));
    _checkStatus(r);
  ...
  Future<Map<String, dynamic>> startMcpServer(
    String serverId, {
    ...
    final r = await http
        .post(
          ...
          headers: _headers,
          body: jsonEncode({
            if (initParams != null && initParams.isNotEmpty)
  ...
  Future<void> stopMcpServer(String serverId) async {
    ...
    final r = await http
        .post(
          Uri.parse(_url('/api/v1/mcp/servers/$encoded/stop')),
          headers: _headers,
        )
        .timeout(_timeout);
    _checkStatus(r);
  ...
  Future<List<Map<String, dynamic>>> getMcpServerTools(String serverId) async {
    ...
    final r = await http
        .get(
          Uri.parse(_url('/api/v1/mcp/servers/$encoded/tools')),
          headers: _headers,
        )
        .timeout(_timeout);
    _checkStatus(r);
    final body = jsonDecode(r.body) as Map<String, dynamic>;
    return (body['tools'] as List? ?? [])
        .whereType<Map<String, dynamic>>()
        .toList();
  }

  /// Calls a tool on a running MCP proxy server.
  Future<Map<String, dynamic>> callMcpServerTool(
    String serverId,
    String toolName,
    ...
    final r = await http
        .post(
          Uri.parse(
            _url('/api/v1/mcp/servers/$encoded/tools/$encodedTool/call'),
          ),
          headers: _headers,
  ...
  Future<List<Map<String, dynamic>>> getAllSkillDefs() async {
    final r = await http
        .get(Uri.parse(_url('/api/v1/skill-defs')), headers: _headers)
        .timeout(_timeout);
    _checkStatus(r);
  ...
  Future<Map<String, dynamic>?> getSkillDef(String id) async {
    final r = await http
        .get(
          Uri.parse(_url('/api/v1/skill-defs/${Uri.encodeComponent(id)}')),
          headers: _headers,
        )
        .timeout(_timeout);
    _checkStatus(r);
  ...
  Future<void> saveSkillDef(Map<String, dynamic> skillDef) async {
    ...
    final url = id != null
        ? _url('/api/v1/skill-defs/${Uri.encodeComponent(id)}')
        : _url('/api/v1/skill-defs');
    final r = id != null
        ? await http
              .put(
                Uri.parse(url),
                headers: _headers,
                body: jsonEncode(skillDef),
              )
              .timeout(_timeout)
        : await http
              .post(
  ...
  Future<List<Map<String, dynamic>>> getAllSkills({String? mcpType}) async {
    final params = mcpType != null
        ? '?mcp_type=${Uri.encodeComponent(mcpType)}'
        : '';
    final r = await http
        .get(Uri.parse(_url('/api/v1/skills$params')), headers: _headers)
        .timeout(_timeout);
    _checkStatus(r);
    final body = jsonDecode(r.body) as Map<String, dynamic>;
    return (body['skills'] as List? ?? [])
        .whereType<Map<String, dynamic>>()
        .toList();
  }
  ...
  Future<void> saveSkill(Map<String, dynamic> skillJson) async {
    final r = await http
        .put(
          Uri.parse(_url('/api/v1/skills')),
          headers: _headers,
          body: jsonEncode(skillJson),
        )
        .timeout(_timeout);
    _checkStatus(r);
  }
  ...
  Future<void> deleteSkill(String id) async {
    final r = await http
        .delete(
          Uri.parse(_url('/api/v1/skills/${Uri.encodeComponent(id)}')),
          headers: _headers,
        )
        .timeout(_timeout);
    _checkStatus(r);
  ...
  Future<void> deleteSkillByToolName(String toolName) async {
    final r = await http
        .delete(
          Uri.parse(
            _url('/api/v1/skills/tool/${Uri.encodeComponent(toolName)}'),
          ),
          headers: _headers,
        )
        .timeout(_timeout);
  ...
  Future<Map<String, dynamic>> buildServerSkills({
    ...
    final r = await http
        .post(
          Uri.parse(_url('/api/v1/skills/build')),
          headers: _headers,
          body: jsonEncode(body),
        )
        .timeout(_timeout);
  ...
  Future<Map<String, dynamic>> getServerSkillsBuildStatus({
    Duration? timeout,
  }) async {
    final r = await http
  ...
  Future<List<Map<String, dynamic>>> getPlaygroundSessions() async {
    final r = await http
        .get(Uri.parse(_url('/api/v1/playground/sessions')), headers: _headers)
        .timeout(_timeout);
    _checkStatus(r);
    final body = jsonDecode(r.body) as Map<String, dynamic>;
  ...
  Future<void> deletePlaygroundSession(String id) async {
    final r = await http
        .delete(
          Uri.parse(_url('/api/v1/playground/sessions/$id')),
          headers: _headers,
        )
        .timeout(_timeout);
    _checkStatus(r);
